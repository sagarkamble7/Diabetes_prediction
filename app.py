...
with open(r'D:\Sagar_Kamble_DiabetesPrediction\diabetes_svc_model.pkl', "rb") as f:
        model = pickle.load(f)
...
insulin = st.number_input("Insulin Level min_value=0, max_value=900", min_value=0, max_value=900 )
